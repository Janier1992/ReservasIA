...
export function RegisterPage() {
  ...
  if (pendingEmail) {
    return (
      <AuthLayout title="Verificá tu email" subtitle={`Ingresá el código que enviamos a ${pendingEmail}`}>
  ...
  return (
    <AuthLayout title="Crear cuenta" subtitle="Empezá a gestionar las reservas de tu negocio">
