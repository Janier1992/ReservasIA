...
// inyecta la lista real de archivos acá en build. Los datos del negocio
// (reservas, conversaciones) nunca pasan por este cache: siempre van a
// InsForge/compute service por red.
