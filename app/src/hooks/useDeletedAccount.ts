...
/**
 * Si el negocio de este usuario fue eliminado por un admin de soporte
 * (tabla `deleted_user_accounts`, poblada por un trigger cuando se borra
 * una organización desde /soporte — ver migración
 * 20260922090000_tombstone-support-deleted-accounts.sql). InsForge no
